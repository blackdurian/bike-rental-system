        ...
        <div class="card-header card-header-tabs card-header-primary">
          <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
              <span class="nav-tabs-title">Stations:</span>
                ...
                <tbody>
                  ...
                  ?>
                      <tr id="tr-<?php echo $result[$k]["id"]; ?>">
                        ...
                        <td>
                          <input class="input-<?php echo $result[$k]["id"]; ?>  col-md-12" id="address-input-<?php echo $result[$k]["id"]; ?>" type="text" value="<?php echo $result[$k]["address"]; ?>" disabled>
                        </td>
                        <td class="td-actions text-right">
                          ...
                          <button type="button" title="Delete" class="btn btn-danger btn-link btn-sm" onclick="<?php echo 'deleteStation(\'' . $result[$k]["id"] . '\')'; ?>">
